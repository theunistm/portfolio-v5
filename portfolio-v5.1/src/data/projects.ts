...
export const projects: ProjectProps[] = [
  // 6. My Pharmacy — videos (6 flows)
  {
    ...
    flows: [
      { page: 'Home', challenge: 'Surface the right info first without noise.', solution: 'We grouped key signals into clear widgets, so users land, scan, and act in seconds. Home dwell time dropped ~15%.', media: { type: 'video', src: '/flows/videos/my-pharmacy/01-mp-home.webm' } },
      { page: 'Prescriptions', challenge: 'Juggling scripts across pharmacies is confusing and time‑heavy.', solution: 'One prescription hub with live status, co‑pay alerts, and delivery options. Pharmacy members reported script reorder time cut in half.', media: { type: 'video', src: '/flows/videos/my-pharmacy/02-mp-scripts.webm' } },
      { page: 'Medical info', challenge: 'Make personal health details easy to view and share securely.', solution: 'We created a digital medical card that captures essentials and can be shared via email, text, or PDF with medical professionals.', media: { type: 'video', src: '/flows/videos/my-pharmacy/03-mp-medical.webm' } },
      { page: 'Store catalogue', challenge: 'Help people find the right product fast, then present its details without overwhelm.', solution: 'Structured categories with smart search/filters and consistent product cards (price, availability). On the PDP, a progressive layout surfaces essentials first. Result: first‑result add‑to‑cart up ~14%, overall PDP add‑to‑cart up ~12%.', media: { type: 'video', src: '/flows/videos/my-pharmacy/04-mp-store.webm' } },
      { page: 'Wallet', challenge: 'Add payment methods safely and track where money goes.', solution: 'We created a central wallet for secure cards, cashback, and per‑card history. Easy payment method set up allowed for 100% success rate to add new cards.', media: { type: 'video', src: '/flows/videos/my-pharmacy/05-mp-wallet.webm' } },
      { page: 'Wellness hubs', challenge: 'Users hunt across scattered sources for critical care product info.', solution: 'Dedicated brand hubs gather products, guidance, and updates in one trusted space.', media: { type: 'video', src: '/flows/videos/my-pharmacy/06-mp-hubs.webm' } },
    ],
  },
  ...
  // 5. Vouch — images (3 flows)
  {
    ...
    flows: [
      { page: 'Home', challenge: 'Show the essentials without creating noise for the user.', solution: 'We grouped key info on one screen, User balance, Redeem actions, and History overview, so staff get what they need at a glance.', media: { type: 'image', src: '/flows/images/vouch/01-v-home.webp' } },
      ...
      { page: 'Redemption history', challenge: 'Make large volumes of redemption data easy to scan and trust.', solution: 'Hierarchical layout with clear states and timestamps; newest first, with searchable detail views for quick look‑ups and audits.', media: { type: 'image', src: '/flows/images/vouch/03-v-history.webp' } },
    ],
  },
  ...
  // 4. My Rental — images (4 flows)
  {
    ...
    flows: [
      { page: 'Home', challenge: 'How to effectively show the essential info with little to no noise. ', solution: 'We surfaced the key signals (rental stage, car status, pickup/return times, and timely notices) so users understand “where they are” at a glance.', media: { type: 'image', src: '/flows/images/my-rental/01-mr-home.webp' } },
      { page: 'SOS', challenge: 'In stressful moments, information must be instant and unambiguous.', solution: 'We provide big, readable actions with tap‑to‑call emergency numbers and share‑my‑location, plus graceful fallbacks when GPS isn’t available.', media: { type: 'image', src: '/flows/images/my-rental/02-mr-sos.webp' } },
      { page: 'Points of attraction', challenge: 'How to Hhelp travellers find the right places fast. while keeping the info minimal.', solution: 'A curated, categorised list (fuel, towns, attractions, campsites) ranked by proximity, with one‑tap directions or call.', media: { type: 'image', src: '/flows/images/my-rental/03-mr-navigate.webp' } },
      { page: 'Voucher tracking', challenge: 'Tracking and redeeming provider vouchers is fiddly across emails and texts.', solution: 'All vouchers live in‑app and are visible, scannable, and quickly redeemable with provider, with a clear record of what’s been used.', media: { type: 'image', src: '/flows/images/my-rental/04-mr-vouchers.webp' } },
    ],
  },
  ...
  // 3. PayBuddy — videos (7 flows)
  {
    ...
    flows: [
      { page: 'Sending money', challenge: 'Move money fast without friction.', solution: 'Send and request share one simple pattern - pick a contact, enter an amount, add a note - so there’s zero guesswork.', media: { type: 'video', src: '/flows/videos/paybuddy/01-pb-send.webm' } },
      { page: 'Scam notifications', challenge: 'Give users clear warning before they commit.', solution: 'KYC and verification run by default; when something looks off, we surface a plain‑language alert upfront so users can pause or proceed informed.', media: { type: 'video', src: '/flows/videos/paybuddy/02-pb-scam.webm' } },
      { page: 'Request notifications', challenge: 'Make money requests feel natural, not nagging.', solution: 'Requests appear in‑app and on the widget, quietly, no spammy pushes, leaving the conversation to people, not the app.', media: { type: 'video', src: '/flows/videos/paybuddy/03-pb-request.webm' } },
      { page: 'Card linkage', challenge: 'Bridge the digital wallet to a physical card.', solution: 'Link in seconds via a card‑tied QR code, with a guided flow that’s quick and visually reassuring.', media: { type: 'video', src: '/flows/videos/paybuddy/04-pb-link.webm' } },
      { page: 'Onboarding', challenge: ' Invite users at the right moment without getting in the way.', solution: 'A contextual “Join PayBuddy” entry in Wallet, present when useful, informing users of the benefits upfront.', media: { type: 'video', src: '/flows/videos/paybuddy/05-pb-onboarding.webm' } },
      { page: 'Card update notification', challenge: 'Confirm upgrades instantly and unmistakably.', solution: 'Animated iconography and clear status text show the new tier is live and ready.', media: { type: 'video', src: '/flows/videos/paybuddy/06-pb-card.webm' } },
      { page: 'Tier update', challenge: 'Explain tier options and benefits at a glance.', solution: 'Clean comparisons with focused visuals and plain‑English perks help users choose the right tier quickly.', media: { type: 'video', src: '/flows/videos/paybuddy/07-pb-upgrade.webm' } },
    ],
  },
  ...
  // 2. Buddy SuperApp — videos (5 flows)
  {
    ...
    theme: { color: '#A07303', hoverColor: '#F7EED2' },
    flows: [
      { page: 'App navigation', challenge: 'Organise a multi‑function app born from four products without losing coherence.', solution: 'A calm home with interactive, info‑rich widgets; core flows grouped by intent and connection; niche features tucked into a clear “More” menu.', media: { type: 'video', src: '/flows/videos/superapp/01-bsa-pages.webm' } },
      { page: 'Buddy Eats', challenge: 'Bring a top‑tier food‑ordering experience to Namibia—rich menus, zero confusion.', solution: 'Transparent ordering with clear progress (browse → customise → checkout → track), detailed menus, and status that keeps users oriented end‑to‑end.', media: { type: 'video', src: '/flows/videos/superapp/02-bsa-eats.webm' } },
      { page: 'Ask Buddy', challenge: 'Serve niche requests with a tailored, human touch.', solution: 'Ask Buddy—our concierge chat—connects users to the team in real time to source, arrange, and confirm bespoke requests.', media: { type: 'video', src: '/flows/videos/superapp/03-bsa-ask.webm' } },
      { page: 'In-app rewards', challenge: 'Help users track and use rewards without hunting.', solution: 'A single rewards hub for Smile$: balance, earning history, and ways to redeem. Visible at a glance, usable in a tap.', media: { type: 'video', src: '/flows/videos/superapp/04-bsa-rewards.webm' } },
      { page: 'Value-added services', challenge: 'Make essentials (airtime, utilities, bundles) quick to find and buy.', solution: 'A unified VAS storefront with clear categories, prices, and instant checkout. No detours, no guesswork.', media: { type: 'video', src: '/flows/videos/superapp/05-bsa-vas.webm' } },
    ],
  },
  ...
  // 1. Travel Guru — images (7 flows)
  {
    ...
    flows: [
      { page: 'Guru onboarding', challenge: 'Get users creating quickly while building trust.', solution: 'Short, clear steps (email/Apple/Google + phone verification), pick interests/country, set avatar, with an optional “Become a Travel Guru” path for monetisation.', media: { type: 'video', src: '/flows/videos/travel-guru/01-tg-onboarding.webm' } },
      { page: 'Travel map', challenge: 'Turn scattered posts into meaningful, place‑based discovery.', solution: 'Map‑first home with location pins, mixed‑media previews, and quick tag filters. Tap any place to dive into local content.', media: { type: 'image', src: '/flows/images/travel-guru/02-tg-map.webp' } },
      { page: 'Explore country', challenge: 'Help travellers orient fast in a new country.', solution: 'Country hub with a “Welcome” hero and showing curated content of the country.', media: { type: 'image', src: '/flows/images/travel-guru/03-tg-country.webp' } },
      { page: 'Detailed search', challenge: 'Find the right experience across media and places.', solution: 'Tagged, filterable search across blogs, videos, podcasts, and locations, ranked by relevance with country and tag pivots.', media: { type: 'video', src: '/flows/videos/travel-guru/04-tg-search.webm' } },
      { page: 'Community', challenge: 'Turn scattered travel questions into reliable, local answers without endless threads or noise.', solution: 'A structured Community page with topic tags, country/location context, and an “accepted answer” system — surfacing the most helpful reply first while keeping the full discussion accessible', media: { type: 'video', src: '/flows/videos/travel-guru/05-tg-community.webm' } },
      { page: 'Content types', challenge: 'What are the best ways for users to present rich media with context without clutter.', solution: 'Clean detail views per type with location, tags, and creator info up front; standard actions (save, share, report) and premium gating when applicable.', media: { type: 'video', src: '/flows/videos/travel-guru/06-tg-create.webm' } },
      { page: 'Content creation', challenge: 'Let creators create and publish robust posts without friction.', solution: 'Guided flows for blog/video/podcast: title, tags, location, media, preview, and publish.', media: { type: 'video', src: '/flows/videos/travel-guru/07-tg-posting.webm' } },
    ],
  },
];
