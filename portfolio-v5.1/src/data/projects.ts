...
export const projects: ProjectProps[] = [
  ...
  // 3. PayBuddy — videos (7 flows)
  {
    ...
    flows: [
      { page: 'Sending money', challenge: 'Move money fast without friction.', solution: 'Send and request share one simple pattern - pick a contact, enter an amount, add a note - so there’s zero guesswork.', media: { type: 'video', src: '/flows/videos/paybuddy/01-pb-send.mp4' } },
      { page: 'Scam notifications', challenge: 'Give users clear warning before they commit.', solution: 'KYC and verification run by default; when something looks off, we surface a plain‑language alert upfront so users can pause or proceed informed.', media: { type: 'video', src: '/flows/videos/paybuddy/02-pb-scam.mp4' } },
      { page: 'Request notifications', challenge: 'Make money requests feel natural, not nagging.', solution: 'Requests appear in‑app and on the widget, quietly, no spammy pushes, leaving the conversation to people, not the app.', media: { type: 'video', src: '/flows/videos/paybuddy/03-pb-request.mp4' } },
      { page: 'Card linkage', challenge: 'Bridge the digital wallet to a physical card.', solution: 'Link in seconds via a card‑tied QR code, with a guided flow that’s quick and visually reassuring.', media: { type: 'video', src: '/flows/videos/paybuddy/04-pb-link.mp4' } },
      { page: 'Onboarding', challenge: ' Invite users at the right moment without getting in the way.', solution: 'A contextual “Join PayBuddy” entry in Wallet, present when useful, informing users of the benefits upfront.', media: { type: 'video', src: '/flows/videos/paybuddy/05-pb-onboarding.mp4' } },
      { page: 'Card update notification', challenge: 'Confirm upgrades instantly and unmistakably.', solution: 'Animated iconography and clear status text show the new tier is live and ready.', media: { type: 'video', src: '/flows/videos/paybuddy/06-pb-card.mp4' } },
      { page: 'Tier update', challenge: 'Explain tier options and benefits at a glance.', solution: 'Clean comparisons with focused visuals and plain‑English perks help users choose the right tier quickly.', media: { type: 'video', src: '/flows/videos/paybuddy/07-pb-upgrade.mp4' } },
    ],
  },
  ...
  // 2. Buddy SuperApp — videos (5 flows)
  {
    ...
    theme: { color: '#A07303', hoverColor: '#F7EED2' },
    flows: [
      { page: 'App navigation', challenge: 'Organise a multi‑function app born from four products without losing coherence.', solution: 'A calm home with interactive, info‑rich widgets; core flows grouped by intent and connection; niche features tucked into a clear “More” menu.', media: { type: 'video', src: '/flows/videos/superapp/01-bsa-pages.mp4' } },
      { page: 'Buddy Eats', challenge: 'Bring a top‑tier food‑ordering experience to Namibia—rich menus, zero confusion.', solution: 'Transparent ordering with clear progress (browse → customise → checkout → track), detailed menus, and status that keeps users oriented end‑to‑end.', media: { type: 'video', src: '/flows/videos/superapp/02-bsa-eats.mp4' } },
      { page: 'Ask Buddy', challenge: 'Serve niche requests with a tailored, human touch.', solution: 'Ask Buddy—our concierge chat—connects users to the team in real time to source, arrange, and confirm bespoke requests.', media: { type: 'video', src: '/flows/videos/superapp/03-bsa-ask.mp4' } },
      { page: 'In-app rewards', challenge: 'Help users track and use rewards without hunting.', solution: 'A single rewards hub for Smile$: balance, earning history, and ways to redeem. Visible at a glance, usable in a tap.', media: { type: 'video', src: '/flows/videos/superapp/04-bsa-rewards.mp4' } },
      { page: 'Value-added services', challenge: 'Make essentials (airtime, utilities, bundles) quick to find and buy.', solution: 'A unified VAS storefront with clear categories, prices, and instant checkout. No detours, no guesswork.', media: { type: 'video', src: '/flows/videos/superapp/05-bsa-vas.mp4' } },
    ],
  },
